/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 6f0b1b1044fe20e736f3cdee66ce77aa)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	ROI_LEADS: KVNamespace;
	ROI_DATA_TTL_SECONDS: string;
	DELIVERY_MODE: string;
	BOOKING_URL: string;
	ALLOWED_ORIGINS: string;
	RESEND_API_KEY: string;
	FROM_EMAIL: string;
	FOUNDER_REPLY_TO: string;
	SLACK_WEBHOOK_URL: string;
	LEAD_LOG_WEBHOOK_URL: string;
	LEAD_LOG_WEBHOOK_SECRET: string;
	STAGING_SUBMISSION_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ROI_DATA_TTL_SECONDS" | "DELIVERY_MODE" | "BOOKING_URL" | "ALLOWED_ORIGINS" | "RESEND_API_KEY" | "FROM_EMAIL" | "FOUNDER_REPLY_TO" | "SLACK_WEBHOOK_URL" | "LEAD_LOG_WEBHOOK_URL" | "LEAD_LOG_WEBHOOK_SECRET" | "STAGING_SUBMISSION_TOKEN" | "TEST_EMAIL_ALLOWLIST">> {}
}
