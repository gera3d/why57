...
const EXPERIMENT_REGISTRY = [
  ...
  },
  {
    ...
    startDate:    null,
    endDate:      null,
    hypothesis:   '"See If You\'re a Fit" may increase scheduling clicks over the neutral "Request a Fit Call" baseline.',
    primaryMetric: 'calendar_booking_clicked',
    primaryMetricLabel: 'Booking Click',
    guardrails:   ['bounce_rate'],
    control:      { label: 'Control', description: '"Request a Fit Call"' },
  ...
  {
    id:           'price_signal',
    name:         'Pricing Process Near CTA',
    status:       'draft',
    startDate:    null,
    endDate:      null,
    hypothesis:   'A brief description of the scope and written-pricing process near the CTA may help visitors understand the commercial process.',
    primaryMetric: 'calendar_booking_clicked',
    primaryMetricLabel: 'Booking Click',
    guardrails:   ['bounce_rate'],
    control:      { label: 'Control', description: 'No pricing-process note near the CTA' },
    variant:      { label: 'Variant A', description: 'Reserved for owner-approved commercial-process copy' },
    trafficSplit: 50,
    targetDays:   14,
    firebaseExpId: null,
    rcParams:     ['show_price_signal', 'price_signal_text'],
    notes:        'Disabled pending owner confirmation of the current commercial policy and authenticated production Remote Config review.',
  },
  {
